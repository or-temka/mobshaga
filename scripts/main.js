...
const nonUseBtn = new NonUseBtn(
  ...
  [
    ...
    {".msgs-btn": "Извините, отправка сообщений будет доступна в скором времени."},
    {".person-notifications": "Извините, объявления временно недоступны, но уже находятся в разработке."},
    {"#shops-menu-link": "Извините, магазины будут доступны позже. Мы уже работаем над ними."},
    {"#shops-menu-link": "Извините, магазины будут доступны позже. Мы уже работаем над ними."},
  ],
